...
// After deletion, the iterator is either:
//
...
// - pointing to the predecessor of the deleted node,
//   if the iterator was pointing at the tail before LLIterDelete was called.
//
